...
contract('MarketPlace',function(accounts){
  ...
  it("should let us sell a first article", function() {
    return MarketPlace.deployed().then(function(instance) {
      marketPlaceInstance = instance;
      return marketPlaceInstance.sellArticle(articleName1, articleDescription1, web3.toWei(articlePrice1, "ether"), {
        from: seller
      });
      ...
      return marketPlaceInstance.articles(articleId);
    }).then(function(data) {
  ...
  it("should let us sell a second article", function() {
    return MarketPlace.deployed().then(function(instance) {
      marketPlaceInstance = instance;
      return marketPlaceInstance.sellArticle(articleName2, articleDescription2, web3.toWei(articlePrice2, "ether"), {
        from: seller
      });
    }).then(function(receipt) {
  ...
  it("should let us buy the first article", function() {
    return MarketPlace.deployed().then(function(instance) {
      ...
      return marketPlaceInstance.buyArticle(articleId, {
        from: buyer,
